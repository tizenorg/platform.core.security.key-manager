...
BOOST_AUTO_TEST_CASE(TMM_0010_NoListener) {
    ...
    BOOST_REQUIRE_MESSAGE(!mgr.SendMessage(MessageA(22)), "There should be no listener.");
}
...
BOOST_AUTO_TEST_CASE(TMM_0020_Basic) {
    ...
    BOOST_REQUIRE_MESSAGE(mgr.SendMessage(MessageA(4)), "No listener found");
...
BOOST_AUTO_TEST_CASE(TMM_0030_MultipleMessages) {
    ...
    BOOST_REQUIRE_MESSAGE(mgr.SendMessage(MessageB('c')), "No listener found");
    ...
    BOOST_REQUIRE_MESSAGE(mgr.SendMessage(MessageA(42)), "No listener found");
...
BOOST_AUTO_TEST_CASE(TMM_0040_Listener) {
    ...
    BOOST_REQUIRE_MESSAGE(mgr.SendMessage(MessageC("lorem ipsum")), "No listener found");
    ...
    BOOST_REQUIRE_MESSAGE(mgr.SendMessage(MessageA(3)), "No listener found");
...
BOOST_AUTO_TEST_CASE(TMM_0050_2Listeners) {
    ...
    BOOST_REQUIRE_MESSAGE(mgr.SendMessage(MessageA(5)), "No listener found");
