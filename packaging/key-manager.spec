...
if [ $1 = 0 ]; then
    # unistall
    systemctl daemon-reload
# It will be required if modification of setup package fails.
# Curretly we assume that setup will create user/group for key
# manager and we should not remove them.
