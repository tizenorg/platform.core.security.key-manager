...
std::map<AlgoType, ValidatorVector> g_validators = {
        { AlgoType::RSA_SV, VBuilder<HashAlgoCheck, RsaPaddingCheck>::Build() },
        { AlgoType::DSA_SV, VBuilder<HashAlgoCheck>::Build() },
        { AlgoType::ECDSA_SV, VBuilder<HashAlgoCheck>::Build() },
        { AlgoType::RSA_GEN, VBuilder<RsaKeyLenCheck>::Build() },
        { AlgoType::DSA_GEN, VBuilder<DsaKeyLenCheck>::Build() },
        { AlgoType::ECDSA_GEN, VBuilder<EcdsaEcCheck>::Build() },
        { AlgoType::AES_GEN, VBuilder<AesKeyLenCheck>::Build() },
        { AlgoType::AES_CTR, VBuilder<IvSizeCheck, CtrLenCheck>::Build() },
        { AlgoType::AES_CBC, VBuilder<IvSizeCheck>::Build() },
        { AlgoType::AES_CFB, VBuilder<IvSizeCheck>::Build() },
        { AlgoType::AES_GCM, VBuilder<GcmIvCheck, GcmTagCheck>::Build() },
};
...
void validateParams(const CryptoAlgorithm& ca)
{
    ...
    for(const auto& it : g_validators.at(at)) {
        it->Check(ca);
    }
}
