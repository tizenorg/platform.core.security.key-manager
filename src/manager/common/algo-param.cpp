...
int CryptoAlgorithm::BaseParam::getBuffer(RawBuffer&) const
{
    return false;
}

int CryptoAlgorithm::BaseParam::getInt(uint64_t&) const
{
    return false;
}

int CryptoAlgorithm::BufferParam::getBuffer(RawBuffer& buffer) const
{
    buffer = m_buffer;
    return true;
}
...
int CryptoAlgorithm::IntParam::getInt(uint64_t& value) const
{
    value = m_int;
    return true;
}
