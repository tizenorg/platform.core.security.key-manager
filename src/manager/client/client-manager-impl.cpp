...
int Manager::Impl::getPKCS12(const Alias &alias, const Password &keyPass, const Password &certPass,
							 PKCS12ShPtr &pkcs) {
	if (alias.empty())
		return CKM_API_ERROR_INPUT_PARAM;
...
int Manager::Impl::createKeyPairRSA(
	...
	return this->createKeyPair(CKM::KeyType::KEY_RSA_PUBLIC, size, privateKeyAlias, publicKeyAlias,
...
int Manager::Impl::createKeyPairDSA(
	...
	const Policy &policyPrivateKey,
	const Policy &policyPublicKey) {
	return this->createKeyPair(CKM::KeyType::KEY_DSA_PUBLIC, size, privateKeyAlias, publicKeyAlias,
							   policyPrivateKey, policyPublicKey);
}
...
int Manager::Impl::createKeyPairECDSA(
	...
	const Policy &policyPrivateKey,
	const Policy &policyPublicKey) {
	return this->createKeyPair(CKM::KeyType::KEY_ECDSA_PUBLIC, static_cast<int>(type), privateKeyAlias,
