...
int ManagerImpl::crypt(const CryptoAlgorithm &algo,
          const Alias &keyAlias,
          const Password &password,
...
int ManagerImpl::encrypt(const CryptoAlgorithm &algo,
            ...
            RawBuffer& encrypted)
{
    return crypt(algo, keyAlias, password, plain, encrypted, EncryptionCommand::DECRYPT);
}
...
int ManagerImpl::decrypt(const CryptoAlgorithm &algo,
                         ...
                         RawBuffer& decrypted)
{
    return crypt(algo, keyAlias, password, encrypted, decrypted, EncryptionCommand::ENCRYPT);
}
