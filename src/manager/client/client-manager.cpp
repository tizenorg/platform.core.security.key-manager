...
int Manager::createKeyPairRSA(
	...
	return m_impl->createKeyPairRSA(size, privateKeyAlias, publicKeyAlias, policyPrivateKey,
									policyPublicKey);
}
...
int Manager::createKeyPairDSA(
	...
	const Policy &policyPrivateKey,
	const Policy &policyPublicKey) {
	return m_impl->createKeyPairDSA(size, privateKeyAlias, publicKeyAlias, policyPrivateKey,
									policyPublicKey);
}
...
int Manager::createKeyPairECDSA(
	...
	const Policy &policyPrivateKey,
	const Policy &policyPublicKey) {
	return m_impl->createKeyPairECDSA(type, privateKeyAlias, publicKeyAlias, policyPrivateKey,
									  policyPublicKey);
}
