...
SWKeyFile::RSAKeyHandler::RSAKeyHandler(SWKeyFile & parent) : m_parent(parent) {}
...
Crypto::GKeyShPtr SWKeyFile::RSAKeyHandler::getPrivKey() {
    return std::make_shared<Crypto::SW::AKey>(Crypto::SW::AKey(m_encryptedKey, DataType::KEY_RSA_PRIVATE));
}
