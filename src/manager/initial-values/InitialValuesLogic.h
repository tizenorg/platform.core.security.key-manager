 ...
 *
 *
 * @file        InitialValuesLogic.h
 * @author      Maciej Karpiuk (m.karpiuk2@samsung.com)
 * @version     1.0
 * @brief       InitialValuesLogic class.
 */

#ifndef INITIALVALUESLOGIC_H_
#define INITIALVALUESLOGIC_H_
...
class InitialValuesLogic
{
public:
    InitialValuesLogic(CKMLogic * db_logic) : m_db_logic(db_logic) {}
