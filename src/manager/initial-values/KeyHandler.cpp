...
{
    if     (typeStr == std::string(XML_ATTR_TYPE_VAL_RSA_PRV))      return KeyType::KEY_RSA_PRIVATE;
    else if(typeStr == std::string(XML_ATTR_TYPE_VAL_RSA_PUB))      return KeyType::KEY_RSA_PUBLIC;
    else if(typeStr == std::string(XML_ATTR_TYPE_VAL_DSA_PRV))      return KeyType::KEY_DSA_PRIVATE;
    else if(typeStr == std::string(XML_ATTR_TYPE_VAL_DSA_PUB))      return KeyType::KEY_DSA_PUBLIC;
    else if(typeStr == std::string(XML_ATTR_TYPE_VAL_ECDSA_PRV))    return KeyType::KEY_ECDSA_PRIVATE;
    else if(typeStr == std::string(XML_ATTR_TYPE_VAL_ECDSA_PUB))    return KeyType::KEY_ECDSA_PUBLIC;
    else if(typeStr == std::string(XML_ATTR_TYPE_VAL_AES))          return KeyType::KEY_AES;
