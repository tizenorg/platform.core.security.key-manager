...
RawBuffer CKMService::ProcessStorage(Credentials &cred, MessageBuffer &buffer, bool allowed)
{
    ...
    if (!allowed) {
        ...
        Serializer<int,int,int>::Serialize(response, command, msgID, CKM_API_ERROR_ACCESS_DENIED);
    }
    ...
    switch(static_cast<LogicCommand>(command)) {
        case LogicCommand::SAVE:
        {
            ...
            if (!allowed) {
                Serializer<int>::Serialize(response, static_cast<int>(DataType(tmpDataType)));
                return response.Pop();
            }
        ...
        case LogicCommand::GET:
        {
            ...
            if (!allowed) {
                Serializer<int,RawBuffer>::Serialize(response,
        ...
        case LogicCommand::GET_PKCS12:
        {
            ...
            if (!allowed) {
                Serializer<PKCS12Serializable>::Serialize(response, PKCS12Serializable());
                return response.Pop();
            }
        ...
        case LogicCommand::GET_LIST:
        {
            ...
            if (!allowed) {
                Serializer<int, LabelNameVector>::Serialize(response,
                                                            static_cast<int>(DataType(tmpDataType)),
                                                            LabelNameVector());
                return response.Pop();
            }
        ...
        case LogicCommand::GET_CHAIN_CERT:
        {
            ...
            if (!allowed) {
                Serializer<RawBufferVector>::Serialize(response, RawBufferVector());
                return response.Pop();
            }
        ...
        case LogicCommand::GET_CHAIN_ALIAS:
        {
            ...
            if (!allowed) {
                Serializer<LabelNameVector>::Serialize(response, LabelNameVector());
                return response.Pop();
            }
        ...
        case LogicCommand::CREATE_SIGNATURE:
        {
            ...
            if (!allowed) {
                Serializer<RawBuffer>::Serialize(response, RawBuffer());
                return response.Pop();
            }
