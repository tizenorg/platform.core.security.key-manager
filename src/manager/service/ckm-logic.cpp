        ...
        const RSAPaddingAlgorithm padding)
{
    ...
    cryptoAlg.m_params.emplace(ParamName::SV_HASH_ALGO, IntParam::create(static_cast<int>(hash)));
    cryptoAlg.m_params.emplace(ParamName::SV_RSA_PADDING, IntParam::create(static_cast<int>(padding)));
