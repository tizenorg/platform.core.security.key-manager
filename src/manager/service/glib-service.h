...
public:
    ...
    GLIBService();
    GLIBService(const GLIBService &) = delete;
    GLIBService(GLIBService &&) = delete;
    GLIBService& operator=(const GLIBService &) = delete;
    GLIBService& operator=(GLIBService &&) = delete;
