 ...
 *
 * @param[in] algo              Structure describing an algorithm to be used
 * @param[in] key_alias         Alias of the key to be used for encryption
 * @param[in] data_size         Size of the data to be encrypted
 * @param[in] data              Data to be encrypted
 * @param[out] encrypted_size   Size of encrypted data
 * @param[out] encrypted        Encrypted data (some algorithms may return additional information
 ...
 * @pre User is already logged in and the user key is already loaded into memory in plain text form.
 */
int ckmc_encrypt_data(const ckmc_encryption_algo_s* algo,
...
/**
 * @brief Dencrypts data using selected key and algorithm
 *
 * @since_tizen 3.0
 * @privlevel public
 * @privilege %http://tizen.org/privilege/keymanager
 ...
 * @param[in] algo              Structure describing an algorithm to be used
 * @param[in] key_alias         Alias of the key to be used for encryption
 * @param[in] data_size         Size of the data to be decrypted
 * @param[in] data              Data to be decrypted
 * @param[out] decrypted_size   Size of decrypted data
 * @param[out] decrypted        Decrypted data (some algorithms may return additional information
 *                              embedded in encrypted data. AES GCM is an example)
 *
 * @return @c 0 on success, otherwise a negative error value
 *
 ...
 * @pre User is already logged in and the user key is already loaded into memory in plain text form.
 */
int ckmc_decrypt_data(const ckmc_encryption_algo_s* algo,
                      const char *key_alias,
                      const unsigned long long data_size,
                      const char* data,
