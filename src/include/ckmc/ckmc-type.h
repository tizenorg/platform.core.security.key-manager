 ...
 *
 * @param[in] ppparams Double pointer to the handle of param list to which the
 ...
 * @see #ckmc_param_name_e
 */
int ckmc_param_list_new(ckmc_param_list_h **ppparams);
 ...
 *                      New param with @a name and @a value will be added here
 ...
 * @see #ckmc_param_name_e
 */
int ckmc_param_list_add_integer(ckmc_param_list_h *params,
 ...
 * @param[in] params    Algorithm param list handle created with
 *                      ckmc_param_list_new() or ckmc_generate_new_params()
 *                      New param with @a name and @a buffer will be added here
 * @param[in] name      Name of parameter to add \n
 *                      Existing parameter will be overwritten \n
 *                      Passing invalid parameter name will result in an error
 ...
 * @see #ckmc_param_name_e
 */
int ckmc_param_list_add_buffer(ckmc_param_list_h *params,
                               ckmc_param_name_e name,
...
int ckmc_param_list_get_integer(const ckmc_param_list_h *params,
                                ckmc_param_name_e name,
                                uint64_t *pvalue);
 ...
 * @see #ckmc_param_name_e
 */
int ckmc_param_list_get_buffer(const ckmc_param_list_h *params,
                               ckmc_param_name_e name,
 ...
 *          Initialization vectors are left empty (they have to be added manually). Caller is
 ...
 * @param[out] ppparams  Newly generated handle of param list which should be freed by caller after used
 *
 * @return #CKMC_ERROR_NONE on success,
 *         otherwise a negative error value
 *
 ...
 * @see #ckmc_param_name_e
 */
int ckmc_generate_new_params(ckmc_algo_type_e type, ckmc_param_list_h **ppparams);
